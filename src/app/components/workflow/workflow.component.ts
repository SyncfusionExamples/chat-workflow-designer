...
import { DiagramComponent, DiagramModule, NodeModel, SelectorConstraints, SelectorModel, UserHandleModel } from '@syncfusion/ej2-angular-diagrams';
...
export class WorkflowComponent {
  ...
  public onEntryNodeClick(): void {
    ...
    this.diagram.selectedItems = this.selectedItems;
      ...
      if(this.diagram?.selectedItems.nodes)
        {
          ...
          if (selectedNode && selectedNode.wrapper && selectedNode.width && this.dialog?.position) {
            ...
            this.dialog.position = dialogPosition; // Set dialog position
          }
        }
    }
  }
